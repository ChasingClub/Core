...
import static chasingclub.server.core.Utils.Utils.noperm;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if(sender instanceof Player){
            ...
            if(blockbelow.getBlock().getType() == Material.AIR ||
                ...
                p.sendMessage(PluginName+ChatColor.RED+"You can't set spawn in the air!");
                return true;
            }
            ...
            p.sendMessage(PluginName+ChatColor.GREEN+ChatColor.BOLD+"Set Spawn Completed!");
            plugin.saveConfig();
        }else{
